...
|[Applying string functions](./03-query/07-functions-datetime.ipynb)|See how different string functions can be used at ingestion and query time.|`druid-jupyter`|
