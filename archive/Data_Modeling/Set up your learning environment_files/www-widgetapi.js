(function(){'use strict';var n;function ca(a){var b=0;return function(){return b<a.length?{done:!1,value:a[b++]}:{done:!0}}}
...
r("Symbol.iterator",function(a){if(a)return a;a=Symbol("Symbol.iterator");p(Array.prototype,a,{configurable:!0,writable:!0,value:function(){return ea(ca(this))}});
return a});
...
function x(a){var b=typeof Symbol!="undefined"&&Symbol.iterator&&a[Symbol.iterator];if(b)return b.call(a);if(typeof a.length=="number")return{next:ca(a)};throw Error(String(a)+" is not an iterable or ArrayLike");}
...
function c(e,h){var l=e[1];return ea(function(){if(l){for(;l.head!=e[1];)l=l.previous;for(;l.next!=l.head;)return l=l.next,{done:!1,value:h(l)};l=null}return{done:!0,value:void 0}})}
...
var O=Error;N.prototype=fa(O.prototype);N.prototype.constructor=N;if(ja)ja(N,O);else for(var P in O)if(P!="prototype")if(Object.defineProperties){var Wa=Object.getOwnPropertyDescriptor(O,P);Wa&&Object.defineProperty(N,P,Wa)}else N[P]=O[P];N.H=O.prototype;function Xa(a){Qa.test(a)&&(a.indexOf("&")!=-1&&(a=a.replace(Ka,"&amp;")),a.indexOf("<")!=-1&&(a=a.replace(La,"&lt;")),a.indexOf(">")!=-1&&(a=a.replace(Ma,"&gt;")),a.indexOf('"')!=-1&&(a=a.replace(Na,"&quot;")),a.indexOf("'")!=-1&&(a=a.replace(Oa,"&#39;")),a.indexOf("\x00")!=-1&&(a=a.replace(Pa,"&#0;")));return a}
