...
Making the effort to identify the correct timestamp and the value of individual dimensions (attributes and measures) for your datasource will pay dividends later on. Armed with your Learn Druid develooper environment, it's time to take a look at some notebooks that cover functionality you need to be familiar with as you go iterate through different table schemas.
...
Open JupyterLab in your [Learn Druid developer environment](/courses/resources) .

Under the ingestion section, we recommend that you run through these notebooks:

- Batch ingestion ([local](http://localhost:8889/lab/tree/02-ingestion) | [source](/resources/blob/main/notebooks/02-ingestion/02-batch-ingestion.ipynb)) - it covers the basics of ingestion, including how to specify the columns that you choose to ingest into your table.
- Data types ([local](http://localhost:8889/lab/workspaces/auto-s/tree/02-ingestion/04-table-datatypes.ipynb) | [source](/resources/blob/main/notebooks/02-ingestion/04-table-datatypes.ipynb)) - this will familiarise you with how data is stored inside a table.
...
- Datetime functions ([local](http://localhost:8889/lab/tree/03-query/07-functions-datetime.ipynb) | [source](/resources/blob/main/notebooks/03-query/07-functions-datetime.ipynb))

You might also want to round out your knowledge by looking at the notebooks on NULL values ([local](http://localhost:8889/lab/tree/02-ingestion/09-generating-and-working-with-nulls.ipynb) | [source](/resources/blob/main/notebooks/02-ingestion/09-generating-and-working-with-nulls.ipynb)).
...
- String functions ([local](http://localhost:8889/lab/tree/03-query/08-functions-strings.ipynb) | [source](/resources/blob/main/notebooks/03-query/08-functions-strings.ipynb))
- The CASE function notebook ([local](http://localhost:8889/lab/tree/03-query/09-functions-case.ipynb) | [source](/resources/blob/main/notebooks/03-query/09-functions-case.ipynb))
- IP address functions ([local](http://localhost:8889/lab/tree/03-query/10-functions-ip.ipynb) | [source](/resources/blob/main/notebooks/03-query/10-functions-ip.ipynb))
- Window functions ([local](http://localhost:8889/lab/tree/03-query/13-functions-window.ipynb) | [source](/resources/blob/main/notebooks/03-query/13-functions-window.ipynb))

And in the ingestion section:

- The notebook on nested columns ([local](http://localhost:8889/lab/tree/02-ingestion/05-working-with-nested-columns.ipynb) | [source](/resources/blob/main/notebooks/02-ingestion/05-working-with-nested-columns.ipynb))
- Arrays and UNNEST ([local](http://localhost:8889/lab/tree/02-ingestion/08-table-datatypes-arrays.ipynb) | [source](/resources/blob/main/notebooks/02-ingestion/08-table-datatypes-arrays.ipynb))
...
- JOIN operations ([local](http://localhost:8889/lab/tree/03-query/11-joins.ipynb) | [source](/resources/blob/main/notebooks/03-query/11-joins.ipynb))
- Lookup tables ([local](http://localhost:8889/lab/tree/03-query/06-lookup-tables.ipynb) | [source](/resources/blob/main/notebooks/03-query/06-lookup-tables.ipynb))
- Real-time lookup tables ([local](http://localhost:8889/lab/tree/03-query/18-lookup-tables-kafka.ipynb) | [source](/resources/blob/main/notebooks/03-query/18-lookup-tables-kafka.ipynb))
...
- Streaming ingestion with Kafka ([local](http://localhost:8889/lab/tree/02-ingestion/01-streaming-from-kafka.ipynb) | [source](/resources/blob/main/notebooks/02-ingestion/01-streaming-from-kafka.ipynb))